...
public class PostgreSQLLexer extends PostgreSQLLexerBase {
	...
	public static final int
		...
		GRANT=65, GRAPH_TABLE=66, GROUP_P=67, HAVING=68, IN_P=69, INITIALLY=70, 
		INTERSECT=71, INTO=72, LATERAL_P=73, LEADING=74, LIMIT=75, LOCALTIME=76, 
		LOCALTIMESTAMP=77, NOT=78, NULL_P=79, OFFSET=80, ON=81, ONLY=82, OR=83, 
		ORDER=84, PLACING=85, PRIMARY=86, REFERENCES=87, RETURNING=88, SELECT=89, 
		SESSION_USER=90, SOME=91, SYMMETRIC=92, TABLE=93, THEN=94, TO=95, TRAILING=96, 
		TRUE_P=97, UNION=98, UNIQUE=99, USER=100, USING=101, VARIADIC=102, WHEN=103, 
		WHERE=104, WINDOW=105, WITH=106, AUTHORIZATION=107, BINARY=108, COLLATION=109, 
		CONCURRENTLY=110, CROSS=111, CURRENT_SCHEMA=112, FREEZE=113, FULL=114, 
		ILIKE=115, INNER_P=116, IS=117, ISNULL=118, JOIN=119, LEFT=120, LIKE=121, 
		NATURAL=122, NOTNULL=123, OUTER_P=124, OVER=125, OVERLAPS=126, RIGHT=127, 
		SIMILAR=128, VERBOSE=129, ABORT_P=130, ABSOLUTE_P=131, ACCESS=132, ACTION=133, 
		ADD_P=134, ADMIN=135, AFTER=136, AGGREGATE=137, ALSO=138, ALTER=139, ALWAYS=140, 
		ASSERTION=141, ASSIGNMENT=142, AT=143, ATTRIBUTE=144, BACKWARD=145, BEFORE=146, 
		...
		PathPatternStringConstant=646, StringConstant=647, UnterminatedStringConstant=648, 
		UnicodeEscapeStringConstant=649, UnterminatedUnicodeEscapeStringConstant=650, 
		BeginDollarStringConstant=651, BinaryStringConstant=652, UnterminatedBinaryStringConstant=653, 
		InvalidBinaryStringConstant=654, InvalidUnterminatedBinaryStringConstant=655, 
		HexadecimalStringConstant=656, UnterminatedHexadecimalStringConstant=657, 
		InvalidHexadecimalStringConstant=658, InvalidUnterminatedHexadecimalStringConstant=659, 
		Integral=660, NumericFail=661, Numeric=662, PLSQLVARIABLENAME=663, PLSQLIDENTIFIER=664, 
		Whitespace=665, Newline=666, LineComment=667, BlockComment=668, UnterminatedBlockComment=669, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"InvalidUnterminatedUnicodeQuotedIdentifier", "PathPatternStringConstant", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'FROM'", "'GRANT'", "'GRAPH_TABLE'", "'GROUP'", "'HAVING'", "'IN'", 
			...
			null, null, "'(cust1 IS Customer)-[e1]->(movie IS Movie)<-[e2](cust2 IS Customer)'", 
